export const features = [
  {
    ...
    text: "With AdamFlowAI, manual work disappears. We design AI-powered automations that handle repetitive tasks, streamline operations, and unlock real growth for your business without hiring more people noticing More focus and revenue.",
    button: {
  ...
  },
  {
    ...
    caption: "Efficient integration",
    title: "Built around your business",
    text: "No generic templates. Every workflow is custom-designed to fit your tools, processes, and goals—so your business runs smarter, faster, and more efficiently.",
    button: {
...
export const faq = [
  {
    id: "0",
    question: "How fast can you set up an automation?",
    answer:
      "Most automations are designed, built, and deployed within 3–7 days. Complex workflows may take longer, but you’ll always get a clear timeline before we start.",
  },
  {
    id: "1",
    question: "What tools and platforms do you work with?",
    answer:
      "We integrate with tools like Google Workspace, Gmail, Slack, CRMs, payment systems, databases, and custom APIs. If your tool has an API, we can automate it.",
  },
  {
    id: "2",
    question: "What kind of tasks can you automate?",
    answer:
      "Anything repetitive or rule-based—invoice processing, data entry, lead routing, reporting, email workflows, AI document analysis, and more.",
  },
  {
    id: "3",
    question: "How much does an automation usually cost?",
    answer:
      "Projects typically start around $1,000 and scale based on complexity. Pricing is based on business impact, not hours worked.",
  },
  {
    id: "4",
    question: "Will this work with my existing processes?",
    answer:
      "Yes. We design automations around your current workflow so you don’t need to change how your team works.",
  },
  {
    id: "5",
    question: "Is my data secure?",
    answer:
      "Absolutely. We follow best practices for authentication, access control, and data handling. Your data remains fully owned by you.",
  },
  {
    id: "6",
    question: "What if I need changes later?",
    answer:
      "Automations are built to be flexible. You can request updates, improvements, or scaling as your business grows.",
  },
  {
    id: "7",
    question: "Do you provide documentation and support?",
    answer:
      "Yes. You’ll receive clear documentation and optional ongoing support to ensure everything runs smoothly.",
  },
  {
    id: "8",
    question: "Do you offer training for teams?",
    answer:
      "Yes. We can train your team to use, monitor, and understand the automation—no technical background required.",
  },
  {
    id: "9",
    question: "What if the automation breaks?",
    answer:
      "We include monitoring and error handling. If something fails, you’ll be notified instantly and we’ll help resolve it quickly.",
  },
];
...
export const plans = [
  {
    ...
    priceMonthly: 19,
    priceYearly: 12,
    caption: "Perfect for solo founders or small teams",
    features: [
      "1 custom automation workflow",
      "Up to 5 tools integrated",
      "Email & chat support",
      "1-week deployment",
    ],
  ...
  },
  {
    ...
    priceMonthly: 39,
    priceYearly: 29,
    caption: "For large teams & complex processes",
    features: [
